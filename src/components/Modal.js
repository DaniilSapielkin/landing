...
export default function FormField({ onClose }) {
    ...
    <div className={classes.root}>
      <div className={classes.body}>
        ...
        <form onSubmit={handleSubmit} className={classes.Form}>
          <div
            className={cn(classes.inputBox, {
              [classes.inputError]: errorName,
            })}
          >
            <input
              id="name"
          ...
          <div className={classes.consent}>
            ...
            <div className={classes.consentInfo}>
              I consent to the processing and use of my personal data in
              accordance with the <a href="#">Privacy Policy</a> and accept{" "}
